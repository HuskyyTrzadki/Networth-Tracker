...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-4 [--cell-size:2.25rem] sm:[--cell-size:2.5rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        weekday: cn(
          "text-muted-foreground flex h-8 w-[--cell-size] select-none items-center justify-center rounded-md text-[0.8rem] font-normal",
