...
- `AllocationDonutChart` supports `showSliceLabels` to disable on-chart callouts in dense card layouts and avoid label clipping when an external legend is already present.
