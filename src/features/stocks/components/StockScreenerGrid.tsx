  ...
  return (
    ...
    >
      {cards.map((card) => {
        ...
        return (
          <div key={card.providerKey} className="h-52">
            <div
              className={cn(
                cardVariants(),
                "group relative h-full border-border/20 p-2.5 transition-colors duration-150 hover:border-primary/35 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.5),0_2px_3px_rgba(40,30,18,0.12),0_18px_34px_-24px_rgba(40,30,18,0.55)]"
              )}
            >
              {showRemoveStar ? (
                <Button
