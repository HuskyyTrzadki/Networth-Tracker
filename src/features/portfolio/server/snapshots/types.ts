...
export type SnapshotRowInsert = Readonly<{
  ...
  net_external_cashflow_pln: string | null;
  net_external_cashflow_usd: string | null;
  net_external_cashflow_eur: string | null;
  net_implicit_transfer_pln: string | null;
  net_implicit_transfer_usd: string | null;
  net_implicit_transfer_eur: string | null;
...
export type SnapshotChartRow = Readonly<{
  bucketDate: string;
  totalValuePln: number | null;
  totalValueUsd: number | null;
  totalValueEur: number | null;
  netExternalCashflowPln: number | null;
  netExternalCashflowUsd: number | null;
  netExternalCashflowEur: number | null;
  netImplicitTransferPln: number | null;
  netImplicitTransferUsd: number | null;
  netImplicitTransferEur: number | null;
  isPartialPln: boolean;
  isPartialUsd: boolean;
  isPartialEur: boolean;
}>;
