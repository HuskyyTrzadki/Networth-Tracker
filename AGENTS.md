...
- Portfolio routes (`/portfolio` and `/portfolio/<id>`) now share the same loading skeleton UI, so navigation between portfolios shows immediate feedback while server data streams
