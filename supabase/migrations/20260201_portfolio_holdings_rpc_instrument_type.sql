...
-- Adds instrument_type for concentration and allocation logic.
...
comment on function public.get_portfolio_holdings(uuid) is
  'Aggregates net holdings per instrument (BUY minus SELL) for the current user; null portfolio means all. Includes instrument_type.';
